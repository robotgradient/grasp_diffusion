...
def parse_args():
    ...
    p.add_argument('--spec_file', type=str, default='pointcloud_projected_graspdif'
                   , help='root for saving logging')
...
def main(opt):
    ...
    ## Dataset
    train_dataset = datasets.PointcloudAcronymAndSDFDataset(class_type=opt.class_type, augmented_rotation=True, one_object=args['single_object'])
